...
DarkPink = {
    MainFrame = Color3.fromRGB(255, 105, 180),
    Minimise = Color3.fromRGB(255, 106, 0),
    MinimiseAccent = Color3.fromRGB(147, 59, 0),
    Maximise = Color3.fromRGB(25, 255, 0),
    MaximiseAccent = Color3.fromRGB(0, 255, 110),
    NavBar = Color3.fromRGB(10, 0, 20),          -- glowing dark blackhole
    NavBarAccent = Color3.fromRGB(255, 20, 147), -- deep blackhole pink
    NavBarInvert = Color3.fromRGB(255, 20, 147), -- deep blackhole pink
    TitleBar = Color3.fromRGB(255, 105, 180),
    TitleBarAccent = Color3.fromRGB(10, 0, 20),  -- glowing dark blackhole
    Overlay = Color3.fromRGB(175, 175, 175),
    Banner = Color3.fromRGB(20, 0, 40),          -- glowing dark blackhole
    BannerAccent = Color3.fromRGB(255, 20, 147), -- blackhole pink accent
    Content = Color3.fromRGB(30, 0, 60),         -- glowing dark blackhole
    Button = Color3.fromRGB(255, 20, 147),       -- blackhole pink
    ButtonAccent = Color3.fromRGB(10, 0, 20),    -- glowing dark blackhole
    ChipSet = Color3.fromRGB(235, 235, 235),
    ChipSetAccent = Color3.fromRGB(255, 20, 147),-- blackhole pink
    DataTable = Color3.fromRGB(235, 235, 235),
    DataTableAccent = Color3.fromRGB(255, 20, 147), -- blackhole pink
    Slider = Color3.fromRGB(30, 0, 60),          -- glowing dark blackhole
    SliderAccent = Color3.fromRGB(255, 20, 147), -- blackhole pink
    Toggle = Color3.fromRGB(205, 205, 205),
    ToggleAccent = Color3.fromRGB(255, 20, 147), -- blackhole pink
    Dropdown = Color3.fromRGB(30, 0, 60),        -- glowing dark blackhole
    DropdownAccent = Color3.fromRGB(255, 20, 147), -- blackhole pink
    ColorPicker = Color3.fromRGB(30, 0, 60),     -- glowing dark blackhole
    ColorPickerAccent = Color3.fromRGB(255, 20, 147), -- blackhole pink
    TextField = Color3.fromRGB(175, 175, 175),
    TextFieldAccent = Color3.fromRGB(255, 20, 147), -- blackhole pink
},
	Mocha = {
		MainFrame = Color3.fromRGB(255,255,255),
