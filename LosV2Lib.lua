...
DarkPink = {
    ...
    Maximise = Color3.fromRGB(25, 255, 0),
    MaximiseAccent = Color3.fromRGB(0, 255, 110),
    NavBar = Color3.fromRGB(5, 5, 5),           -- glowing dark blackhole
    NavBarAccent = Color3.fromRGB(255, 105, 180),
    NavBarInvert = Color3.fromRGB(255, 105, 180),
    TitleBar = Color3.fromRGB(255, 105, 180),
    TitleBarAccent = Color3.fromRGB(5, 5, 5),    -- glowing dark blackhole
    Overlay = Color3.fromRGB(175, 175, 175),
    Banner = Color3.fromRGB(5, 5, 5),            -- glowing dark blackhole
    BannerAccent = Color3.fromRGB(5, 5, 5),      -- glowing dark blackhole
    Content = Color3.fromRGB(5, 5, 5),           -- glowing dark blackhole
    Button = Color3.fromRGB(255, 105, 180),
    ButtonAccent = Color3.fromRGB(5, 5, 5),      -- glowing dark blackhole
    ChipSet = Color3.fromRGB(235, 235, 235),
    ChipSetAccent = Color3.fromRGB(5, 5, 5),     -- glowing dark blackhole
    DataTable = Color3.fromRGB(235, 235, 235),
    DataTableAccent = Color3.fromRGB(255, 105, 180),
    Slider = Color3.fromRGB(5, 5, 5),            -- glowing dark blackhole
    SliderAccent = Color3.fromRGB(5, 5, 5),      -- glowing dark blackhole
    Toggle = Color3.fromRGB(205, 205, 205),
    ToggleAccent = Color3.fromRGB(255, 105, 180),
    Dropdown = Color3.fromRGB(5, 5, 5),          -- glowing dark blackhole
    DropdownAccent = Color3.fromRGB(5, 5, 5),    -- glowing dark blackhole
    ColorPicker = Color3.fromRGB(5, 5, 5),       -- glowing dark blackhole
    ColorPickerAccent = Color3.fromRGB(5, 5, 5), -- glowing dark blackhole
    TextField = Color3.fromRGB(175, 175, 175),
    TextFieldAccent = Color3.fromRGB(5, 5, 5),   -- glowing dark blackhole
},
	Mocha = {
		MainFrame = Color3.fromRGB(255,255,255),
