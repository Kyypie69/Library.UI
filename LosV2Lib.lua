...
DarkPink = {
    ...
    Maximise = Color3.fromRGB(25, 255, 0),
    MaximiseAccent = Color3.fromRGB(0, 255, 110),
    NavBar = Color3.fromRGB(255, 105, 180),
    NavBarAccent = Color3.fromRGB(255, 192, 203), -- soft pink
    NavBarInvert = Color3.fromRGB(255, 105, 180),
    TitleBar = Color3.fromRGB(255, 105, 180),
    TitleBarAccent = Color3.fromRGB(255, 192, 203), -- soft pink
    Overlay = Color3.fromRGB(255, 105, 180),
    Banner = Color3.fromRGB(255, 105, 180),
    BannerAccent = Color3.fromRGB(255, 192, 203), -- soft pink
    Content = Color3.fromRGB(255, 192, 203),
    Button = Color3.fromRGB(255, 105, 180), -- hot pink
    ButtonAccent = Color3.fromRGB(255, 192, 203),
    ChipSet = Color3.fromRGB(255, 192, 203),
    ChipSetAccent = Color3.fromRGB(255, 105, 180), -- hot pink
    DataTable = Color3.fromRGB(255, 192, 203),
    DataTableAccent = Color3.fromRGB(255, 105, 180), -- hot pink
    Slider = Color3.fromRGB(255, 192, 203),
    SliderAccent = Color3.fromRGB(255, 105, 180), -- hot pink
    Toggle = Color3.fromRGB(255, 192, 203),
    ToggleAccent = Color3.fromRGB(255, 105, 180), -- hot pink
    Dropdown = Color3.fromRGB(255, 105, 180),
    DropdownAccent = Color3.fromRGB(255, 192, 203), -- soft pink
    ColorPicker = Color3.fromRGB(85, 85, 85),
    ColorPickerAccent = Color3.fromRGB(255, 192, 203), -- soft pink
    TextField = Color3.fromRGB(255, 105, 180),
    TextFieldAccent = Color3.fromRGB(255, 192, 203), -- soft pink
},
	Mocha = {
		MainFrame = Color3.fromRGB(255,255,255),
