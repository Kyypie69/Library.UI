...
DarkPink = {
    ...
    NavBarAccent = Color3.fromRGB(255, 105, 180), -- glowing dark blackhole
    NavBarInvert = Color3.fromRGB(255, 105, 180), -- glowing dark blackhole
    TitleBar = Color3.fromRGB(255, 105, 180),
    TitleBarAccent = Color3.fromRGB(255, 105, 180), -- glowing dark blackhole
    Overlay = Color3.fromRGB(175, 175, 175),
    Banner = Color3.fromRGB(55, 55, 55),
    BannerAccent = Color3.fromRGB(255, 105, 180), -- glowing dark blackhole
    Content = Color3.fromRGB(20, 0, 20), -- glowing dark blackhole base
    Button = Color3.fromRGB(255, 105, 180), -- hot pink
    ButtonAccent = Color3.fromRGB(255, 105, 180), -- glowing dark blackhole
    ChipSet = Color3.fromRGB(235, 235, 235),
    ChipSetAccent = Color3.fromRGB(255, 105, 180), -- glowing dark blackhole
    DataTable = Color3.fromRGB(235, 235, 235),
    DataTableAccent = Color3.fromRGB(255, 105, 180), -- glowing dark blackhole
    Slider = Color3.fromRGB(20, 0, 20), -- glowing dark blackhole base
    SliderAccent = Color3.fromRGB(255, 105, 180), -- glowing dark blackhole
    Toggle = Color3.fromRGB(205, 205, 205),
    ToggleAccent = Color3.fromRGB(255, 105, 180), -- glowing dark blackhole
    Dropdown = Color3.fromRGB(20, 0, 20), -- glowing dark blackhole base
    DropdownAccent = Color3.fromRGB(255, 105, 180), -- glowing dark blackhole
    ColorPicker = Color3.fromRGB(20, 0, 20), -- glowing dark blackhole base
    ColorPickerAccent = Color3.fromRGB(255, 105, 180), -- glowing dark blackhole
    TextField = Color3.fromRGB(175, 175, 175),
