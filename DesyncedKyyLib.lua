...
function KyyfiiiLibrary:createNotification(descriptionText)
    ...
    task.delay(4, function()
        local tweenOut = TweenService:Create(Notification_1, TweenInfo.new(0.5), 
        ...
        for i, notif in ipairs(activeNotifications) do
            ...
            TweenService:Create(notif, TweenInfo.new(0.3), 
                {Position = UDim2.new(1, -10, 1, newY)}):Play()
        end
    end)
end
...
function KyyfiiiLibrary:CreateWindow(Title, Description)
    ...
    Main_1.InputBegan:Connect(function(input)
    ...
    Main_1.InputChanged:Connect(function(input)
    ...
    UIToggler_1.MouseButton1Click:Connect(function()
        uiOpen = not uiOpen
        local tweenInfo = uiOpen and TweenInfo.new(0.5) or TweenInfo.new(0.8)
        local goalPos = uiOpen and UDim2.new(0.5, 0, 0.5, 0) or UDim2.new(0.5, 0, 2, 0)
        
        local tween = TweenService:Create(Main_1, tweenInfo, {Position = goalPos})
        tween:Play()
        dragging = false
        lastGoalPos = nil
        startPos = nil
    ...
    TweenService:Create(UITogglerHolder_1, tweenInfo, 
        {Position = UDim2.new(0.5, 0, 0.015, 0)}):Play()
    TweenService:Create(Main_1, tweenInfo, 
    ...
    function Tabs:CreateTab(Title, Icon)
        ...
        TabTitle_1.TextColor3 = first and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(180, 180, 180)
        ...
        TabIcon_1.ImageColor3 = first and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(180, 180, 180)

        UIPadding_4.Parent = TabsHolder_1
        UIPadding_4.PaddingBottom = UDim.new(0, 4)
        UPadding_4.PaddingLeft = UDim.new(0, 8)
        UPadding_4.PaddingTop = UDim.new(0, 4)
        ...
        TabTitle_1.MouseButton1Click:Connect(function()
            if currentTab == TabTitle_1 then return end
            ...
            TweenService:Create(currentTab, TweenInfo.new(0.2), 
                {TextColor3 = Color3.fromRGB(180, 180, 180)}):Play()
            TweenService:Create(currentIcon, TweenInfo.new(0.2), 
                {ImageColor3 = Color3.fromRGB(180, 180, 180)}):Play()

            TweenService:Create(TabTitle_1, TweenInfo.new(0.2), 
                {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
            TweenService:Create(TabIcon_1, TweenInfo.new(0.2), 
                {ImageColor3 = Color3.fromRGB(255, 255, 255)}):Play()

            newFrame.Position = UDim2.new(direction, 0, 0, 0)
            newFrame.Visible = true

            local tweenOut = TweenService:Create(currentFrame, TweenInfo.new(0.25), 
                {Position = UDim2.new(-direction, 0, 0, 0)})
            local tweenIn = TweenService:Create(newFrame, TweenInfo.new(0.25), 
        ...
        function Elements:CreateButton(Title, Callback)
            ...
            ButtonTitle_1.MouseButton1Click:Connect(function()
                if _G.SafeLock then
                    KyyfiiiLibrary:createNotification("Safe Lock on! Disable to use features.")
                    return
                end

                local tween1 = TweenService:Create(ButtonTitle_1, TweenInfo.new(0.1), 
                    {TextColor3 = Color3.fromRGB(255, 255, 255)})
                tween1:Play()

                tween1.Completed:Connect(function()
                    local tween2 = TweenService:Create(ButtonTitle_1, TweenInfo.new(0.2), 
        ...
        function Elements:CreateToggle(Title, Callback)
            ...
            TogglerHolder_1.Position = UDim2.new(1, -36, 0.5, 0)
            ...
            Toggler_1.MouseButton1Click:Connect(function()
                if _G.SafeLock then
                    if Title == "Safe Lock" then
                        _G.SafeLock = false
                        TweenService:Create(TogglerHolder_1, tweenInfo, 
                            {BackgroundColor3 = Color3.fromRGB(0, 0, 0)}):Play()
                        TweenService:Create(ToggleTitle_1, tweenInfo, 
                ...
                toggled = not toggled
                local targetColor = toggled and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(0, 0, 0)
                local textColor = toggled and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(140, 140, 140)

                TweenService:Create(TogglerHolder_1, tweenInfo, {BackgroundColor3 = targetColor}):Play()
                TweenService:Create(ToggleTitle_1, tweenInfo, {TextColor3 = textColor}):Play()
        ...
        function Elements:CreateBox(Title, Callback)
            ...
            TextBoxHolder_1.AnchorPoint = Vector2.new(1, 0.5)
            ...
            TextBoxHolder_1.Position = UDim2.new(1, -8, 0.5, 0)
            ...
            TextBox_1.Focused:Connect(function()
                ...
                TweenService:Create(BoxTitle_1, TweenInfo.new(0.1), 
                    {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
            end)
            ...
            TextBox_1.FocusLost:Connect(function()
                ...
                TweenService:Create(BoxTitle_1, TweenInfo.new(0.2), 
                    {TextColor3 = Color3.fromRGB(140, 140, 140)}):Play()
            end)
        end
        ...
        function Elements:CreateDropdown(Title, Options, Callback)
            ...
            DropdownBarHolder_1.AnchorPoint = Vector2.new(1, 0.5)
            ...
            DropdownBarHolder_1.Position = UDim2.new(1, -8, 0.5, 0)
            ...
            DropdownToggler_1.Position = UDim2.new(1, -18, 0.5, 0)
            ...
            B_Dropdown_1.Size = UDim2.new(0, 336, 0, 0)
            ...
            local function ToggleDropdown()
                ...
                TweenService:Create(DropdownToggler_1, tweenInfo, {Rotation = targetRotation}):Play()
                ...
                TweenService:Create(DropdownTitle_1, textTweenInfo, {TextColor3 = textColor}):Play()
            end
