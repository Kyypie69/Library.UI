...
function DesyncedLibrary:createNotification(descriptionText)
    ...
    -- Create glowing gradient background for notification
    local NotificationGlow = Instance.new("Frame")
    NotificationGlow.Name = "NotificationGlow"
    NotificationGlow.Parent = Notification_1
    NotificationGlow.Size = UDim2.new(1, 0, 1, 0)
    NotificationGlow.BackgroundColor3 = Color3.fromRGB(0, 191, 255) -- Deep sky blue
    NotificationGlow.BackgroundTransparency = 0.7
    NotificationGlow.BorderSizePixel = 0
    
    local NotificationCorner = Instance.new("UICorner")
    NotificationCorner.Parent = NotificationGlow
    NotificationCorner.CornerRadius = UDim.new(0, 10)
    
    -- Create glass effect with gradient
    local NotificationGradient = Instance.new("UIGradient")
    NotificationGradient.Parent = NotificationGlow
    ...
    local function animateNotificationGradient()
        while Notification_1.Parent do
            for i = 0, 360, 2 do
                if not Notification_1.Parent then break end
                NotificationGradient.Rotation = i
                task.wait(0.05)
            end
        end
    end
    task.spawn(animateNotificationGradient)
    ...
    Background_2.ImageTransparency = 0.45
...
function DesyncedLibrary:CreateWindow(Title, Description)
    ...
    Main_1.BackgroundTransparency = 0.1
    ...
    -- Create glowing deep-sky blue background
    local GlowBackground = Instance.new("Frame")
    GlowBackground.Name = "GlowBackground"
    GlowBackground.Parent = Main_1
    GlowBackground.Size = UDim2.new(1, 0, 1, 0)
    GlowBackground.BackgroundColor3 = Color3.fromRGB(0, 191, 255) -- Deep sky blue
    GlowBackground.BackgroundTransparency = 0.6
    ...
    -- Create animated gradient for glass effect
    local BackgroundGradient = Instance.new("UIGradient")
    BackgroundGradient.Parent = GlowBackground
    BackgroundGradient.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 191, 255)),
        ColorSequenceKeypoint.new(0.3, Color3.fromRGB(64, 156, 255)),
    ...
    -- Animate the gradient (left to right fading effect)
    local function animateBackground()
        while Main_1.Parent do
            for i = 0, 360, 1 do
                if not Main_1.Parent then break end
                BackgroundGradient.Rotation = i
                BackgroundGradient.Offset = Vector2.new(math.sin(math.rad(i * 2)) * 0.3, 0)
                task.wait(0.02)
            end
        end
    end
    ...
    Background_1.ImageTransparency = 0.45
    ...
    User_1.BackgroundTransparency = 0.8
    ...
    UserText_1.TextColor3 = Color3.fromRGB(255, 255, 255) -- Changed to white for better contrast
    ...
    UITogglerHolder_1.BackgroundTransparency = 0.1
    ...
    UIToggler_1.ImageTransparency = 0.45
    ...
    function Tabs:CreateTab(Title, Icon)
        ...
        TabHolder_1.BackgroundTransparency = 0.8
        ...
        TabTitle_1.TextColor3 = Color3.fromRGB(255, 255, 255) -- Changed to white
        ...
        TabIcon_1.ImageColor3 = Color3.fromRGB(255, 255, 255) -- Changed to white
        ...
        if first then
            ...
            TabTitle_1.TextColor3 = Color3.fromRGB(200, 200, 200) -- Lighter gray
            TabIcon_1.ImageColor3 = Color3.fromRGB(200, 200, 200) -- Lighter gray
        end
        ...
        TabTitle_1.MouseButton1Click:Connect(
            function()
                ...
                if currentTab and currentIcon then
                    TweenService:Create(currentTab, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(200, 200, 200)}):Play(

                    )

                    TweenService:Create(currentIcon, TweenInfo.new(0.2), {ImageColor3 = Color3.fromRGB(200, 200, 200)}):Play(
        ...
        function Elements:CreateSection(Title)
            ...
            SectionTitle_1.TextColor3 = Color3.fromRGB(255, 255, 255) -- Changed to white
        ...
        function Elements:CreateLabel(Title)
            ...
            Label_1.BackgroundTransparency = 0.8
            ...
            LabelTitle_1.TextColor3 = Color3.fromRGB(255, 255, 255) -- Changed to white
        ...
        function Elements:CreateButton(Title, Callback)
            ...
            Button_1.BackgroundTransparency = 0.8
            ...
            ButtonTitle_1.TextColor3 = Color3.fromRGB(255, 255, 255) -- Changed to white
            ...
            ButtonTitle_1.MouseButton1Click:Connect(
                function()
                    ...
                    local tween1 =
                        ...
                        ButtonTitle_1,
                        TweenInfo.new(0.1),
                        {TextColor3 = Color3.fromRGB(0, 191, 255)} -- Deep sky blue
                    )
                    tween1:Play()
        ...
        function Elements:CreateToggle(Title, Callback)
            ...
            Toggle_1.BackgroundTransparency = 0.8
            ...
            ToggleTitle_1.TextColor3 = Color3.fromRGB(255, 255, 255) -- Changed to white
                ...
                function()
                    ...
                    if not toggled then
                        local onTween =
                            ...
                            TogglerHolder_1,
                            tweenInfo,
                            {BackgroundColor3 = Color3.fromRGB(0, 191, 255)} -- Deep sky blue
                        )
                        local onTween2 =
                            TweenService:Create(ToggleTitle_1, tweenInfo, {TextColor3 = Color3.fromRGB(0, 191, 255)}) -- Deep sky blue
                        onTween:Play()
                        onTween2:Play()
                        toggled = true
                    else
                        ...
                        local offTween2 =
                            TweenService:Create(ToggleTitle_1, tweenInfo, {TextColor3 = Color3.fromRGB(255, 255, 255)}) -- Back to white
                        offTween:Play()
                        offTween2:Play()
                        toggled = false
                    end
        ...
        function Elements:CreateBox(Title, Callback)
            ...
            Box_1.BackgroundTransparency = 0.8
            ...
            BoxTitle_1.TextColor3 = Color3.fromRGB(255, 255, 255) -- Changed to white
            ...
            TextBox_1.TextColor3 = Color3.fromRGB(255, 255, 255) -- Changed to white
        ...
        function Elements:CreateDropdown(Title, Options, Callback)
            ...
            Dropdown_1.BackgroundTransparency = 0.8
            ...
            SelectedText_1.TextColor3 = Color3.fromRGB(255, 255, 255) -- Changed to white
            ...
            DropdownTitle_1.TextColor3 = Color3.fromRGB(255, 255, 255) -- Changed to white
            ...
            local function ToggleDropdown()
                ...
                local textColor = isDropdownOpen and Color3.fromRGB(0, 191, 255) or Color3.fromRGB(255, 255, 255) -- Deep sky blue or white
            ...
            for _, optionText in ipairs(Options) do
                ...
                button.TextColor3 = Color3.fromRGB(255, 255, 255) -- Changed to white
                button.TextSize = 14
